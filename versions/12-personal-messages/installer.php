...
<head>
    ...
    <title><?= e('HaushaltsPilot Teil 12 Installer') ?></title>
    <style>
...
<body>
    <main class="installer">
        <h1>HaushaltsPilot Teil 12 Installer</h1>
        <p>Teil 12 installiert Speicher, Datenmodell, Admin-Konto, Benutzerrollen, Haushalte/Familien, Listen, Todos und private Nachrichten.</p>
