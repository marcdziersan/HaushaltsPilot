...
<head>
    ...
    <title><?= e('HaushaltsPilot – Teil 10 Gemeinschaftslisten und Admin-Tabs') ?></title>
...
<body>
    <main class="app">
        <section class="topbar">
            <div>
                ...
                <p>Teil 10: Gemeinschaftslisten werden nach Einkaufs-, Haushalts- und sonstigen Listen vertieft. Die Admin-Verwaltung ist jetzt in Tabs aufgeteilt.</p>
            </div>
            <div class="userbox">
        ...
        <div class="note">Sicherheitsbasis bleibt erhalten: Sessions, CSRF, Rollenprüfung, serverseitige Validierung, sichere Textausgabe und PDO Prepared Statements bei SQLite/MySQL. Neu: Haushaltslisten sind fachlich getrennt und die Administration ist übersichtlicher in Tabs organisiert.</div>
        ...
        <section class="panel admin-panel" id="adminPanel">
            ...
            <p>Die Verwaltung ist ab Teil 10 in Tabs getrennt, damit Benutzer, Haushalte und Listen übersichtlich bleiben.</p>
        ...
        <p class="footer-note">Teil 11 kann darauf mit Todos und Aufgaben für eigene und gemeinsame Haushaltsbereiche aufbauen.</p>
    </main>
    ...
    <script>
        ...
        function switchAdminTab(tabName) { adminTabButtons.forEach(function(button){ button.classList.toggle('active', button.dataset.adminTab === tabName); }); adminTabFamilies.classList.toggle('active', tabName === 'families'); adminTabUsers.classList.toggle('active', tabName === 'users'); adminTabLists.classList.toggle('active', tabName === 'lists'); }
