...
function prepare_response_data(array $data, array $user): array
{
    ...
    $payload = [
        ...
        'users' => is_admin($user) ? public_users($data) : [],
...
switch ($action) {
    ...
    case 'delete_list':
        ...
        if ($listIndex === null || !user_can_manage_list($currentUser, $data['lists'][$listIndex])) {
            send_json([
                'success' => false,
                'message' => 'Du darfst diese Liste nicht löschen.',
            ], 403);
        }
