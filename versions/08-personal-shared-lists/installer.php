...
<body>
    <main class="installer">
        ...
        <p>Teil 08 installiert Speicher, Datenmodell, Admin-Konto, Benutzerrollen sowie persönliche und gemeinsame Listenrechte.</p>
        ...
        <form method="post" action="installer.php">
            ...
            <fieldset>
                ...
                <label class="radio-card"><input type="checkbox" name="allow_registration" value="yes" checked><span>Öffentliche Registrierung erlauben<small>Neue Konten erhalten automatisch die Rolle <code>user</code>.</small></span></label>
            </fieldset>
