...
final class PdoStorage implements AppStorageInterface
{
    ...
    public function load(): array
    {
        ...
        $listRows = $this->pdo
            ->query('SELECT id, owner_id, family_id, name, is_shared, created_at FROM lists ORDER BY sort_order ASC, name ASC')
            ->fetchAll();
    ...
    public function save(array $data): void
    {
        ...
        try {
            ...
            $listInsert = $this->pdo->prepare(
                'INSERT INTO lists (id, owner_id, family_id, name, is_shared, sort_order, created_at)
                 VALUES (:id, :owner_id, :family_id, :name, :is_shared, :sort_order, :created_at)'
            );
