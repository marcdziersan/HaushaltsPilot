...
<head>
    ...
    <title><?= e('HaushaltsPilot Teil 15 Installer') ?></title>
    <style>
...
<body>
    <main class="installer">
        <h1>HaushaltsPilot Teil 15 Installer</h1>
        <p>Teil 15 installiert Speicher, Datenmodell, Admin-Konto, Benutzerrollen, Haushalte/Familien, Listen, Todos, private Nachrichten, Chat, Familienchat und Kalender.</p>
