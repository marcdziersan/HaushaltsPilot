...
function normalize_calendar_event_for_scope(array $actor, string $scope, string $title, string $startsAt, string $endsAt, string $location, string $description): array
{
...
switch ($action) {
    ...
    case 'create_calendar_event':
        ...
        $data['calendarEvents'][] = normalize_calendar_event_for_scope($currentUser, $scope, $title, $startsAt, $endsAt, $location, $description);
