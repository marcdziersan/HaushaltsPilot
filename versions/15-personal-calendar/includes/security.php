...
function is_valid_calendar_event(mixed $event): bool
{
    return (
        is_array($event) &&
        isset($event['id'], $event['ownerId'], $event['familyId'], $event['scope'], $event['title'], $event['startsAt'], $event['endsAt'], $event['location'], $event['description'], $event['createdAt'], $event['updatedAt']) &&
        is_string($event['id']) &&
