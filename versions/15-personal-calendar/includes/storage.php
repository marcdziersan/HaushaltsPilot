...
final class PdoStorage implements AppStorageInterface
{
    ...
    public function load(): array
    {
        ...
        $calendarRows = $this->pdo
            ->query('SELECT id, owner_id, family_id, scope, title, starts_at, ends_at, location, description, created_at, updated_at FROM calendar_events ORDER BY starts_at ASC, created_at DESC')
            ->fetchAll();
    ...
    public function save(array $data): void
    {
        ...
        try {
            ...
            $calendarInsert = $this->pdo->prepare(
                'INSERT INTO calendar_events (id, owner_id, family_id, scope, title, starts_at, ends_at, location, description, created_at, updated_at)
                 VALUES (:id, :owner_id, :family_id, :scope, :title, :starts_at, :ends_at, :location, :description, :created_at, :updated_at)'
            );
    ...
    return [
        ...
        'todos' => [
            [
                ...
                'title' => 'Teil 15 testen: Kalendertermin anlegen und bearbeiten',
        ...
        'calendarEvents' => [
            [
                ...
                'location' => 'Zuhause',
                'description' => 'Demo-Termin für Teil 15.',
                'createdAt' => $now,
                'updatedAt' => $now,
            ],
            [
