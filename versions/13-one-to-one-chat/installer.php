...
<head>
    ...
    <title><?= e('HaushaltsPilot Teil 13 Installer') ?></title>
    <style>
...
<body>
    <main class="installer">
        <h1>HaushaltsPilot Teil 13 Installer</h1>
        <p>Teil 13 installiert Speicher, Datenmodell, Admin-Konto, Benutzerrollen, Haushalte/Familien, Listen, Todos, private Nachrichten und direkten 1:1-Chat.</p>
