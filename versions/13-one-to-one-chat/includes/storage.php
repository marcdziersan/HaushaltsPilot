...
CREATE TABLE IF NOT EXISTS message_threads (
    ...
    thread_type ENUM('direct', 'personal_message', 'one_to_one_chat', 'family') NOT NULL DEFAULT 'personal_message',
    created_by VARCHAR(80) NOT NULL,
    created_at DATETIME NOT NULL,
...
SQL);
        ...
        try_add_schema_column($pdo, "ALTER TABLE message_threads MODIFY thread_type ENUM('direct', 'personal_message', 'one_to_one_chat', 'family') NOT NULL DEFAULT 'personal_message'");
    ...
    return [
        ...
        'todos' => [
            [
                ...
                'title' => 'Teil 13 testen: 1:1-Chat öffnen und antworten',
