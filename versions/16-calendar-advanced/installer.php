...
<head>
    ...
    <title><?= e('HaushaltsPilot Teil 16 Installer') ?></title>
    <style>
...
<body>
    <main class="installer">
        <h1>HaushaltsPilot Teil 16 Installer</h1>
        <p>Teil 16 installiert Speicher, Datenmodell, Admin-Konto, Benutzerrollen, Haushalte/Familien, Listen, Todos, private Nachrichten, Chat, Familienchat und den vertieften Kalender.</p>
