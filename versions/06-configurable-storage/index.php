...
$storageLabel = match ($config['storage']) {
    'json' => 'JSON-Datei',
    'sqlite' => 'SQLite über PDO',
    'mysql' => 'MySQL/MariaDB über PDO',
    default => 'Unbekannt',
};
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?= e('HaushaltsPilot – Teil 06 Konfigurierbarer Speicher') ?></title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .app-header h1 { margin: 0 0 8px; font-size: 1.9rem; }
        .app-header p { margin: 0; color: var(--muted); line-height: 1.5; font-size: 0.95rem; }
        ...
        .list-form { display: grid; grid-template-columns: 1fr; gap: 10px; margin-bottom: 14px; }
        ...
        .reset-btn:hover { background: var(--warning-dark); }
        ...
        .list-button small { opacity: 0.8; white-space: nowrap; }
        ...
        .current-title span { color: var(--muted); font-size: 0.9rem; }
        ...
        .stat-card span { display: block; color: var(--muted); font-size: 0.82rem; margin-bottom: 4px; }
        ...
        .shopping-item.done { background: var(--done); opacity: 0.75; }
        ...
        .toggle-btn { background: var(--success); color: white; padding: 8px 10px; font-size: 0.85rem; white-space: nowrap; }
        .toggle-btn:hover { background: var(--success-dark); }
        .delete-btn { background: var(--danger); color: white; padding: 8px 10px; font-size: 0.85rem; white-space: nowrap; }
        ...
        @media (max-width: 520px) {
            ...
            .toggle-btn, .delete-btn { flex: 1; }
            .current-title { display: block; }
            .current-title span { display: block; margin-top: 4px; }
        }
    </style>
</head>
<body>
    ...
    <main class="app">
        <header class="app-header">
            ...
            <p>
                Teil 06 der Tutorial-Reihe.
                Die Speicherart ist jetzt frei konfigurierbar.
            </p>

            <div class="storage-note">
                Aktiver Speicher: <strong><?= e($storageLabel) ?></strong>. Die API bleibt gleich, nur die Speicher-Schicht wurde austauschbar gemacht.
            </div>
        </header>
        ...
        <section class="layout">
            <aside class="panel">
                ...
                <a class="installer-link" href="installer.php">Installer / Speicher ändern</a>
            </aside>
        ...
        <p class="footer-note">
            In Teil 07 bauen wir darauf Login und Benutzerkonten auf.
        </p>
    </main>
    ...
    <script>
        ...
        async function createList() {
            ...
            try {
                const result = await apiPost("create_list", { name: name });
                appData = result.data;
                listNameInput.value = "";
                listNameInput.focus();
                renderApp();
