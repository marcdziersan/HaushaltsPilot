...
<head>
    ...
    <title><?= e('HaushaltsPilot Teil 14 Installer') ?></title>
    <style>
...
<body>
    <main class="installer">
        <h1>HaushaltsPilot Teil 14 Installer</h1>
        <p>Teil 14 installiert Speicher, Datenmodell, Admin-Konto, Benutzerrollen, Haushalte/Familien, Listen, Todos, private Nachrichten, direkten 1:1-Chat und Familienchat.</p>
