...
<head>
    ...
    <title><?= e('HaushaltsPilot – Teil 14 Familienchat') ?></title>
...
<body>
    <div class="app-shell">
        <aside class="sidebar">
            ...
            <div class="sidebar-footer">Teil 14 · Familienchat pro Haushalt mit Gruppenverlauf, Badge und Rechteprüfung.</div>
        </aside>
        ...
        <div class="main-shell">
            ...
            <main class="content">
                <section class="module-page active" id="dashboardPage">
                    <div class="dashboard-hero">
                        <section class="hero-card">
                            ...
                            <p>Teil 14 erweitert das Kommunikationsmodell um einen gemeinsamen Familienchat pro Haushalt. Private Nachrichten, 1:1-Chats und Gruppenchat bleiben fachlich sauber getrennt.</p>
                    ...
                    <section class="dashboard-grid">
                        <div class="panel">
                            ...
                            <div class="dashboard-card-grid">
                                ...
                                <article class="dashboard-card"><strong>Einzelchat</strong><span>Teil 14 nutzt die Chatbasis aus Teil 13 und ergänzt darauf einen haushaltsgebundenen Gruppenchat mit Rechteprüfung über die Familienzuordnung.</span></article>
                            </div>
                        </div>
                        <div class="panel">
                ...
                <p class="footer-note">Teil 14 schließt die Kommunikationsbasis mit privater Nachricht, 1:1-Chat und Familienchat sauber ab.</p>
            </main>
        </div>
    </div>
    ...
    <script>
        ...
        const modulePages = { dashboard:byId('dashboardPage'), lists:byId('listsPage'), todos:byId('todosPage'), messages:byId('messagesPage'), chats:byId('chatsPage'), familychat:byId('familyChatPage'), admin:byId('adminPanel') };
        ...
        let appData = { currentUser:null, currentFamily:null, lists:[], activeListId:null, todos:[], adminTodos:[], messageThreads:[], chatThreads:[], familyChatThreads:[], messages:[], typingIndicators:[], totalUnreadMessages:0, totalUnreadChats:0, totalUnreadFamilyChats:0, adminMessages:[], users:[], activeUsers:[], families:[], isAdmin:false };
        ...
        function renderApp() { renderCurrentUser(); renderUserSelects(); renderListGroups(); renderActiveList(); renderTodos(); renderMessages(); renderChats(); renderFamilyChat(); renderFloatingChat(); renderAdminPanel(); renderDashboardShell(); }
