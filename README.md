...
- Die Anwendung wächst fachlich sinnvoll: Liste → Speicherung → Datenmodell → Backend → Login → Rechte → Haushalt → Todos → private Nachrichten → 1:1-Chat → Familienchat → Kalender → modulare Dashboard-Oberfläche.
